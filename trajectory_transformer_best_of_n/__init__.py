"""Local checkout shim for direct `python -m trajectory_transformer_best_of_n...`.
...
_SRC_PACKAGE = Path(__file__).resolve().parent.parent / "src" / "trajectory_transformer_best_of_n"
